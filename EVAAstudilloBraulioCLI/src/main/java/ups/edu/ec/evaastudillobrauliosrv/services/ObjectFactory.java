...
public class ObjectFactory {
    ...
    private final static QName _GetLibrosResponse_QNAME = new QName("http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", "getLibrosResponse");
    private final static QName _GetLibros_QNAME = new QName("http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", "getLibros");
    private final static QName _CrearLibroResponse_QNAME = new QName("http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", "CrearLibroResponse");
    private final static QName _CrearLibro_QNAME = new QName("http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", "CrearLibro");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ups.edu.ec.evaastudillobrauliosrv.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", name = "getLibrosResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", name = "getLibros")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", name = "CrearLibroResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.EVAAstudilloBraulioSRV.ec.edu.ups/", name = "CrearLibro")
